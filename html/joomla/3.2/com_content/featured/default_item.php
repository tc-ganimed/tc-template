 ...
 *
 * Override for template triumphcompetition - based on joomla 3.1
 *
 */
...
<?php  if (isset($images->image_intro) and !empty($images->image_intro)) : ?>
	...
	<div class="img-intro-<?php echo htmlspecialchars($imgfloat); ?>"  style="background-image: url('<?php echo htmlspecialchars($images->image_intro); ?>');">
		<div class="bg_expander">&nbsp;</div>
	</div>
<?php endif; ?>
